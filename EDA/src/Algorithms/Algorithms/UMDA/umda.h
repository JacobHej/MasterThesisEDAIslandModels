...
/**
 * @brief Class handling functionality and state-keeping for running univariate marginal distribution algorithm  
 */
class umda : public EDABase{
...
public:
     ...
     */
    umda(int my, int lambda, int n, FitnessClass& fitnessclass);
...
private:
    ...
    void update_probability_distribution(SampleContainer& samples, DynamicArray<uint16_t>& indices);
};
